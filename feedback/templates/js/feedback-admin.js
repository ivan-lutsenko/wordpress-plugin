class Causes extends React.Component {
    ...
    deleteCauses(el) {
        ...
        axios.post('/wp-content/plugins/feedback/inquiries.php?inquiries=delete_causes', { data })
            .then(res => {
    ...
    addCauses() {
        ...
        axios.post('/wp-content/plugins/feedback/inquiries.php?inquiries=add_causes', { data })
            .then(res => {
            this.componentDidMount();
        })
    }
...
class Messages extends React.Component {
    ...
    componentDidMount() {
        fetch("/wp-content/plugins/feedback/inquiries.php?inquiries=messages")
            .then(response => response.json())
            .then(commits => {
    ...
    deleteMessages(el) {
        ...
        axios.post('/wp-content/plugins/feedback/inquiries.php?inquiries=delete_messages', { data })
            .then(res => {
            this.componentDidMount();
        })
    }
...
class FeedBack extends React.Component {
    ...
    render() {
        let element = this.state.content?<Causes />:<Messages />;
        return(
            <div>
